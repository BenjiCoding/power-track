...
namespace PT_Plugins
{
    ...
    public interface ILocalPluginContext
    {
        ...
        /// <summary>
        /// Gets a pre-operation image by name, or null when not found.
        /// </summary>
        Entity GetPreImage(string imageName);

        /// <summary>
        /// Gets a post-operation image by name, or null when not found.
        /// </summary>
    ...
    public class LocalPluginContext : ILocalPluginContext
    {
        ...
        public Entity GetPreImage(string imageName)
        {
        ...
        public Entity GetPostImage(string imageName)
        {
            if (string.IsNullOrWhiteSpace(imageName))
            {
                return null;
